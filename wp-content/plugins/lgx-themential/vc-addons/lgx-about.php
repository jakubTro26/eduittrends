...
function lgx_event_about_function($atts)
{
    ...
    $output = '<div class="lgx-about-text">
                           ...
                           '.$lead_text_html.'
                            ...
                            <a class="lgx-btn e lgx-btn-brand lgx-btn-big" href="'.'https://bitrends.pl/#rejestracja'.'"><span>'.$buy_text.'</span></a>
                            <a class="lgx-btn a lgx-btn-big" href="'.'https://bitrends.pl/o-wydarzeniu'.'"><span>'.$buy_textr.'</span></a>
                        </div>';
    return $output;
}
